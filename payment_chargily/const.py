...
# Currency codes of the currencies supported by Chargily in ISO 4217 format.
# See https://api.mercadopago.com/currencies. Last seen online: 24 November 2022.
SUPPORTED_CURRENCIES = [
    'DZD',  # Argentinian Peso
]

# The codes of the payment methods to activate when Chargily is activated.
DEFAULT_PAYMENT_METHODS_CODES = [
    'edahabia',
    'cib',
]

# Mapping of payment method codes to Chargily codes.
# PAYMENT_METHODS_MAPPING = {
#     'card': 'debit_card,credit_card,prepaid_card',
#     'paypal': 'digital_wallet',
# }

# Mapping of transaction states to Chargily payment statuses.
# See https://www.mercadopago.com.mx/developers/en/reference/payments/_payments_id/get.
TRANSACTION_STATUS_MAPPING = {
    'done': ('checkout.paid', ),
    'canceled': ('checkout.canceled',),
    'error': ('checkout.failed', 'checkout.expired'),
}

# Mapping of error states to Chargily error messages.
